...
export const fields = [
	...
	},
	{
		...
		enableSorting: true,
		getValue: ( { item } ) =>
			typeof item.total_files === 'number' ? item.total_files : null,
	...
	},
	{
		...
		enableSorting: true,
		getValue: ( { item } ) =>
			typeof item.total_hooks === 'number' ? item.total_hooks : null,
	...
	},
	{
		...
		enableSorting: true,
		getValue: ( { item } ) =>
			typeof item.total_edges === 'number' ? item.total_edges : null,
